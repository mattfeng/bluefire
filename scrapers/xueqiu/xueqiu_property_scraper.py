# XUEQIU scraper for PROPERTY (房产) news
...
def scrape():
    ...
    col = db["xueqiu_realestate_links_{}".format(now)]

    endpoint = "https://xueqiu.com/v4/statuses/public_timeline_by_category.json?since_id=-1&count=15&category=111"
    ...
    while True:
        ...
        for item in resp_json["list"]:
            ...
            # db=bluefire
            # collection=xueqiu_realestate_links_<datetime>
