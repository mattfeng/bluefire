# XUEQIU scraper for PRIVATE FUND (私募) news
...
def scrape():
    ...
    col = db["xueqiu_privatefund_links_{}".format(now)]

    endpoint = "https://xueqiu.com/v4/statuses/public_timeline_by_category.json?since_id=-1&count=15&category=113"
    ...
    while True:
        ...
        for item in resp_json["list"]:
            ...
            # db=bluefire
            # collection=xueqiu_privatefund_links_<datetime>
