# XUEQIU scraper for INSURANCE (保险) news
...
def scrape():
    ...
    col = db["xueqiu_insurance_links_{}".format(now)]

    endpoint = "https://xueqiu.com/v4/statuses/public_timeline_by_category.json?since_id=-1&count=15&category=110"
    ...
    while True:
        ...
        for item in resp_json["list"]:
            ...
            # db=bluefire
            # collection=xueqiu_insurance_links_<datetime>
